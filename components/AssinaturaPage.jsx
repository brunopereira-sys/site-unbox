...
import { FIcon, FeatGrid, PageHero, useReveal, CrossSellBanner } from './PageKit';
...
function CartUpsellDemo() {
  ...
  const [brigadeiro, setBrigadeiro] = React.useState(null);

  React.useEffect(() => {
    setBrigadeiro(R["brigadeiro-wish"]);
    ...
    <div className="cu-demo">
      ...
      <div className={"cu-cart" + (sub ? " is-sub" : "")}>
        ...
        <div className="cu-item">
          {brigadeiro && <span className="cu-thumb" style={{ backgroundImage: `url(${brigadeiro})` }}></span>}
    ...
    <React.Fragment>
      ...
      <main>
        <PageHero
          ...
          ctaPrimary={<a href={URLS.signup} className="btn btn--primary">Criar conta grátis</a>}
          ...
          <div className="container">
            <div className="final-banner reveal">
              ...
              <div className="final-banner-btns">
                <a href={URLS.signup} className="btn btn--primary">Criar minha conta grátis →</a>
                <a href={URLS.demo} className="btn btn--secondary">Agendar demo</a>
              </div>
            </div>
          </div>
        </section>
