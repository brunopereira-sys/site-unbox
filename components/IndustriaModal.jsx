...
const HABILITAR = "#habilitar-industria";
...
function IndustriaModal() {
  ...
  React.useEffect(() => {
    const getDemoLeads = function () {
      try { return JSON.parse(localStorage.getItem("unbox_industria_leads") || "[]"); }
      catch (_) { return []; }
    };
    window.getIndustriaLeads = getDemoLeads;
    ...
    const clickHandler = (e) => {
      ...
      if (href === HABILITAR || href === "#habilitar-industria") {
        e.preventDefault();
        openHandler();
      }
    };
  ...
  const submit = async (e) => {
    ...
    try {
      const prev = window.getIndustriaLeads ? window.getIndustriaLeads() : [];
      prev.push(lead);
      ...
      <div className="demo-modal-card" role="dialog" aria-modal="true" aria-label="Habilitar minha indústria">
        ...
        {sent ? (
          <div className="demo-modal-success">
            ...
            <a href={URLS.whatsapp} target="_blank" rel="noreferrer" className="btn btn--primary demo-modal-wa-btn">
          ...
          <React.Fragment>
            ...
            <div className="demo-modal-foot">
              ...
              <a href={URLS.whatsapp} target="_blank" rel="noreferrer" className="demo-modal-walink">
