...
import IndustriaModal from './IndustriaModal';
import { Footer, WhatsAppFloater } from './Closing';
import { useReveal } from './PageKit';

const APPLY_IND = "https://admin.credfly.com.br/apply?brand=unboxpay";
    ...
    <section className="crd-section">
      <div className="container">
        ...
        <div className="crd-stats-cta reveal">
          ...
          <a href="/credito" className="btn btn--secondary" style={{ minWidth: 220, justifyContent: "center" }}>Crédito para marcas</a>
        </div>
      </div>
    </section>
  );
