...
import { FIcon, FeatCard, FeatGrid, SubList, useReveal } from './PageKit';
import { FP_ECO, FP_WAYS, FP_INTEGRATIONS, FP_CUSTOM, FP_BOOST, FP_PAY, FP_SHIP, FP_MANAGE, FP_SUPPORT } from './FeaturesData';
      ...
      <main>
        ...
        <section className="section">
          <div className="container">
            ...
            <FeatGrid items={FP_INTEGRATIONS} />
          </div>
        </section>
          ...
          <div className="container">
            <div className="block-head block-head--center reveal">
              ...
              <div className="support-lead">
                ...
                <a href={URLS.whatsapp} target="_blank" rel="noreferrer">pelo WhatsApp →</a>
              </div>
            </div>
            <FeatGrid items={FP_SUPPORT} four />
          </div>
        </section>
